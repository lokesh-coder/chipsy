...
const More = () => {
	...
	return <div className="flex items-center justify-center">
		<div className="flex flex-wrap items-center justify-center">
			{data.map(item => {
				return <a key={item.name} className="flex items-center flex-col justify-center  py-3 px-2 rounded-lg w-1/2 text-teal-600 gap-2 my-2 hover:text-teal-800 " href={item.link} target="_blank" rel="noreferrer">
